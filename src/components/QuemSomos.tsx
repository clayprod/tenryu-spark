      ...
      <div className="container-tenryu">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            A <strong className="text-foreground">Tenryu Consulting</strong> nasceu em 2021 com o propósito de apoiar empresas que buscam 
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="card-tenryu">
            <div className="text-center lg:text-left">
              <div className="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mx-auto lg:mx-0 mb-6">
