  ...
  return (
    <section id="servicos" className="section-padding bg-secondary/30">
      <div className="container-tenryu">
          ...
          {services.map((service, index) => (
            <div key={index} className="card-tenryu group h-full">
              <div className="flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-foreground mb-4 font-exo">
                  {service.title}
                </h3>
        ...
        {/* Process Section */}
        <div className="mb-20">
          <h3 className="text-2xl md:text-3xl font-bold text-center mb-12 text-foreground font-exo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              <div key={index} className="text-center relative">
                ...
                <h4 className="text-lg font-bold text-foreground mb-2 font-exo">
                  {step.title}
                </h4>
        ...
        <div className="bg-gradient-hero rounded-2xl p-8 md:p-12 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-6 font-exo">
